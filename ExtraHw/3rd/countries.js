...
function newGame() {
    round = 1;
    score = 0;
    sideInfo(round, score);
}

function headering(country) {
    let countryName = document.getElementById("countryName");
    let countryFlag = document.getElementById("countryImage");
    // let countryEmoji = document.getElementById("countryEmoji");

    console.log(country);
    countryName.innerHTML = country.name;
    countryFlag.setAttribute("src", getCountryImage(country.code));
    countryFlag.src = getCountryImage(country.code);
}


function sideInfo(round = 1, score = 0) {
...
function getCountry() {
    let country = countryObjects[round - 1];
